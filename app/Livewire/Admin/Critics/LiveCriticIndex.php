...
class LiveCriticIndex extends Component
{
    ...
    {
        return redirect()->to(route('admin.critics.show', ['critic' => $id]));
    }

    public function create()
    {
        return redirect()->to(route('admin.critics.create'));
    }
    ...
    public function render()
    {
        ...
        return view('livewire.admin.critics.live-critic-index', compact('critics'))->extends('layouts.admin-panel')->section('content');
    }
}
