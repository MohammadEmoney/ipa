<div class="container-fluid">
    <livewire:admin.components.live-breadcrumb :items="[['title' => __('global.documents'), 'route' => route('admin.documents.index')], ['title' => $title]]" />
    <div class="card">
        <div class="card-body">
            <h3 class="">{{ $title }}</h3>
            <div>
                                            ...
                                            <div class="row">
                                                <div class="row">
                                                    ...
                                                    @if (isset($data['attachment']))
                                                        ...
                                                        @else
                                                            <div class="col-md-6 px-5 mb-3">
                                                                <span class="cursor-pointer" wire:click="download()"><i class="ti ti-file-check text-success" style="font-size: 4rem"></i></span>
                                                                <span class="fs-4 position-absolute text-danger cursor-pointer" wire:click="deleteMedia({{ $data['attachment']->id }}, 'attachment')"><i class="ti ti-trash"></i></span>
                                                            </div>
                                                        @endif
                                                    @endif
                                                </div>
