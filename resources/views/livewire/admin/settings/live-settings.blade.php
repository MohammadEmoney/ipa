                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col">
                                            ...
                                            <ul class="nav nav-pills" role="tablist" wire:ignore>
                                                ...
                                                <li class="nav-item" role="presentation">
                                                    <button class="nav-link mouse-enter1" id="pills-languages-tab" data-bs-toggle="pill" data-bs-target="#pills-languages" type="button" role="tab" aria-controls="pills-languages" aria-selected="false">{{ __('global.languages') }}</button>
                                                </li>
                                            </ul>
                                            <!-- Tabs Content -->
                                            <div class="tab-content bg-white p-4">
                                                ...
                                                <div class="tab-pane fade" wire:ignore.self id="pills-languages" role="tabpanel" aria-labelledby="pills-languages-tab">
                                                    <div class="row justify-content-center w-100">
                                                        <div class="col-md-12">
                                                            <form wire:submit.prevent="submit">
                                                                <div class="row">
                                                                    <div class="col-md-12 mb-3" wire:ignore>
                                                                        <label for="exampleInputtext1" class="form-label">{{ __('global.languages') }}</label>
                                                                            <select id="payment_via" class="form-control select2"
                                                                                onchange="livewireSelect2Multi('languages', this)"
                                                                                wire:model.live="languages" multiple>
                                                                                <option value="">{{ __('global.select_item') }}</option>
                                                                                @foreach ($langs as $key => $value)
                                                                                    <option value="{{ $key }}">{{ $value }}</option>
                                                                                @endforeach
